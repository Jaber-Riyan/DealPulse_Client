...
export const Navbar: React.FC = () => {
  const { darkMode, toggleDarkMode, user, sidebarOpen, setSidebarOpen } =
    useApp();
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {user ? (
            <Link
              to="/feed"
              className="flex items-center gap-1.5 px-4 py-2 rounded-xl font-medium text-sm transition-all shadow-sm hover:opacity-90"
